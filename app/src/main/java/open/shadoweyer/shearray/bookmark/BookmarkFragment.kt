...
class BookmarkFragment : Fragment(), UserInteractionHandler {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        back.setOnClickListener {
            if (!requireContext().components.bookmarkMediator.handleBackPressed()) {
        ...
        export.setOnClickListener {
            ...
            createFileIntent.putExtra(Intent.EXTRA_TITLE, "Bookmark.html")

            startActivityForResult(createFileIntent, fileReqID)
        }
        bookmark_close.setOnClickListener {
            parentFragmentManager.popBackStack()
        }
    }
    ...
    override fun onBackPressed(): Boolean {
        return requireContext().components.bookmarkMediator.handleBackPressed()
    }
}